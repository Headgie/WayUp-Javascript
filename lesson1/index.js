...
const population = 12655050;
const hasFootbalStadium = true; 
...
console.log(`Площадь прямоугольника: ${square}см.`);
/* 
    Задание 3:
...
console.log(`Сгенерировано число randomNumber=${randomNumber}.`);
